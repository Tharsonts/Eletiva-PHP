...
<style>
    ...
    canvas {
        ...
        width: 100vw;
        height: 100vh;
        z-index: -1; /* Mantém o canvas ao fundo */
    }
    ...
    .btn-view {
        background-color: #17a2b8; /* Mesma cor do blade de artworks */
    }
    ...
    .btn-edit {
        background-color: #ffc107; /* Mesma cor do blade de artworks */
    }
    ...
    .btn-add {
        ...
        border-radius: 5px;
        text-decoration: none;
        margin-bottom: 20px; /* Ajuste maior no espaçamento */
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\teste\projetobd\resources\views/artists/index.blade.php ENDPATH**/ ?>