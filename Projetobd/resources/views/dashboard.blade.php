...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('artists.index') }}">Cadastrar Artistas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('artworks.index') }}">Cadastrar Obras de Arte</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('expositions.index') }}">Cadastrar Exposições</a>
                </li>
            </ul>
